...
module PoolParty
  ...
  module Remote    
    ...
    class RemoterBase
      ...
      def launch_new_instance!(o={});self.class.launch_new_instance!(options.merge(o));end
      # Terminate an instance by id
      def self.terminate_instance!(o={})
        raise RemoteException.new(:method_not_defined, "terminate_instance!")
      end
      def terminate_instance!(o={});self.class.terminate_instance!(options.merge(o));end
      # Describe an instance's status
      def self.describe_instance(o={})
        raise RemoteException.new(:method_not_defined, "describe_instance")
      end
      def describe_instance(o={});self.class.describe_instance!(options.merge(o));end
      # Get instances
      ...
      def describe_instances(o={});self.class.describe_instances!(options.merge(o));end
