...
require "open-uri"
  describe "basic" do
    ...
    it "should set the pool instances" do
      pools[:application].maximum_instances.should == 50
      pools[:application].minimum_instances.should == 3
    end
    it "should have set some default values on the pool" do
      pools[:application].secret_access_key.should ==  Default.secret_access_key
      pools[:application].minimum_runtime.should == 3000
    end
    ...
    it "should inherit the maximum_instances on the cloud from the containing pool" do
    ...
    it "should have the keypair set for the specific cloud on top of the keypair stack" do
      pending
      #TODO: Decide if this should be the behavior. #mf
